...
<html lang="en" data-content_root="../../../../../../../../" >
  ...
  <head>
    ...
    <title>body-parser &#8212; COMSC341-CD: Causal Inference for Data Science</title>
...
<link rel="preload" as="script" href="../../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=3ee479438cf8b5e0d341" />
  <script src="../../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=3ee479438cf8b5e0d341"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'test_myst/_build/templates/site/myst/article-theme/node_modules/body-parser/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../../_sources/test_myst/_build/templates/site/myst/article-theme/node_modules/body-parser/README.md" target="_blank"
...
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#bodyparser-json-options">bodyParser.json([options])</a><ul class="nav section-nav flex-column">
...
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#inflate">inflate</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#limit">limit</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#reviver">reviver</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#strict">strict</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#type">type</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#verify">verify</a></li>
</ul>
</li>
</ul>
</li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#bodyparser-raw-options">bodyParser.raw([options])</a><ul class="nav section-nav flex-column">
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#id1">Options</a><ul class="nav section-nav flex-column">
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id2">inflate</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id3">limit</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id4">type</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id5">verify</a></li>
</ul>
</li>
</ul>
</li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#bodyparser-text-options">bodyParser.text([options])</a><ul class="nav section-nav flex-column">
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#id6">Options</a><ul class="nav section-nav flex-column">
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#defaultcharset">defaultCharset</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id7">inflate</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id8">limit</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id9">type</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id10">verify</a></li>
</ul>
</li>
</ul>
</li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#bodyparser-urlencoded-options">bodyParser.urlencoded([options])</a><ul class="nav section-nav flex-column">
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#id11">Options</a><ul class="nav section-nav flex-column">
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#extended">extended</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id12">inflate</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id13">limit</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#parameterlimit">parameterLimit</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id14">type</a></li>
<li class="toc-h5 nav-item toc-entry"><a class="reference internal nav-link" href="#id15">verify</a></li>
</ul>
</li>
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#depth">depth</a></li>
</ul>
</li>
</ul>
</li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#errors">Errors</a><ul class="nav section-nav flex-column">
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#content-encoding-unsupported">content encoding unsupported</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#entity-parse-failed">entity parse failed</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#entity-verify-failed">entity verify failed</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#request-aborted">request aborted</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#request-entity-too-large">request entity too large</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#request-size-did-not-match-content-length">request size did not match content length</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#stream-encoding-should-not-be-set">stream encoding should not be set</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#stream-is-not-readable">stream is not readable</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#too-many-parameters">too many parameters</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#unsupported-charset-bogus">unsupported charset “BOGUS”</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#unsupported-content-encoding-bogus">unsupported content encoding “bogus”</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#the-input-exceeded-the-depth">The input exceeded the depth</a></li>
</ul>
</li>
...
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#express-connect-top-level-generic">Express/Connect top-level generic</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#express-route-specific">Express route-specific</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#change-accepted-type-for-parsers">Change accepted type for parsers</a></li>
</ul>
</li>
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="body-parser">
<h1>body-parser<a class="headerlink" href="#body-parser" title="Link to this heading">#</a></h1>
<p><a class="reference external" href="https://npmjs.org/package/body-parser"><img alt="NPM Version" src="https://badgen.net/npm/v/body-parser" /></a>
<a class="reference external" href="https://npmjs.org/package/body-parser"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/body-parser" /></a>
<a class="reference external" href="https://github.com/expressjs/body-parser/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/expressjs/body-parser/master?label=ci" /></a>
<a class="reference external" href="https://coveralls.io/r/expressjs/body-parser?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/expressjs/body-parser/master" /></a>
<a class="reference external" href="https://ossf.github.io/scorecard-visualizer/#/projects/github.com/expressjs/body-parser"><img alt="OpenSSF Scorecard Badge" src="https://api.scorecard.dev/projects/github.com/expressjs/body-parser/badge" /></a></p>
...
<h3>bodyParser.json([options])<a class="headerlink" href="#bodyparser-json-options" title="Link to this heading">#</a></h3>
...
<section id="inflate">
<h5>inflate<a class="headerlink" href="#inflate" title="Link to this heading">#</a></h5>
...
<section id="limit">
<h5>limit<a class="headerlink" href="#limit" title="Link to this heading">#</a></h5>
...
<section id="reviver">
<h5>reviver<a class="headerlink" href="#reviver" title="Link to this heading">#</a></h5>
...
<section id="strict">
<h5>strict<a class="headerlink" href="#strict" title="Link to this heading">#</a></h5>
...
<section id="verify">
<h5>verify<a class="headerlink" href="#verify" title="Link to this heading">#</a></h5>
...
<h3>bodyParser.raw([options])<a class="headerlink" href="#bodyparser-raw-options" title="Link to this heading">#</a></h3>
...
the following keys:</p>
<section id="id2">
<h5>inflate<a class="headerlink" href="#id2" title="Link to this heading">#</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</section>
<section id="id3">
<h5>limit<a class="headerlink" href="#id3" title="Link to this heading">#</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
...
<section id="id5">
<h5>verify<a class="headerlink" href="#id5" title="Link to this heading">#</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</section>
...
<h3>bodyParser.text([options])<a class="headerlink" href="#bodyparser-text-options" title="Link to this heading">#</a></h3>
...
<h5>defaultCharset<a class="headerlink" href="#defaultcharset" title="Link to this heading">#</a></h5>
...
<section id="id7">
<h5>inflate<a class="headerlink" href="#id7" title="Link to this heading">#</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</section>
<section id="id8">
<h5>limit<a class="headerlink" href="#id8" title="Link to this heading">#</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
...
<section id="id9">
<h5>type<a class="headerlink" href="#id9" title="Link to this heading">#</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">type</span></code> option is used to determine what media type the middleware will
...
<section id="id10">
<h5>verify<a class="headerlink" href="#id10" title="Link to this heading">#</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</section>
...
<h3>bodyParser.urlencoded([options])<a class="headerlink" href="#bodyparser-urlencoded-options" title="Link to this heading">#</a></h3>
...
<section id="extended">
<h5>extended<a class="headerlink" href="#extended" title="Link to this heading">#</a></h5>
...
<section id="id12">
<h5>inflate<a class="headerlink" href="#id12" title="Link to this heading">#</a></h5>
<p>When set to <code class="docutils literal notranslate"><span class="pre">true</span></code>, then deflated (compressed) bodies will be inflated; when
<code class="docutils literal notranslate"><span class="pre">false</span></code>, deflated bodies are rejected. Defaults to <code class="docutils literal notranslate"><span class="pre">true</span></code>.</p>
</section>
<section id="id13">
<h5>limit<a class="headerlink" href="#id13" title="Link to this heading">#</a></h5>
<p>Controls the maximum request body size. If this is a number, then the value
specifies the number of bytes; if it is a string, the value is passed to the
<a class="reference external" href="https://www.npmjs.com/package/bytes">bytes</a> library for parsing. Defaults
to <code class="docutils literal notranslate"><span class="pre">'100kb'</span></code>.</p>
...
<h5>parameterLimit<a class="headerlink" href="#parameterlimit" title="Link to this heading">#</a></h5>
...
<section id="id14">
<h5>type<a class="headerlink" href="#id14" title="Link to this heading">#</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">type</span></code> option is used to determine what media type the middleware will
parse. This option can be a string, array of strings, or a function. If not
a function, <code class="docutils literal notranslate"><span class="pre">type</span></code> option is passed directly to the
<a class="reference external" href="https://www.npmjs.org/package/type-is#readme">type-is</a> library and this can
...
<section id="id15">
<h5>verify<a class="headerlink" href="#id15" title="Link to this heading">#</a></h5>
<p>The <code class="docutils literal notranslate"><span class="pre">verify</span></code> option, if supplied, is called as <code class="docutils literal notranslate"><span class="pre">verify(req,</span> <span class="pre">res,</span> <span class="pre">buf,</span> <span class="pre">encoding)</span></code>,
where <code class="docutils literal notranslate"><span class="pre">buf</span></code> is a <code class="docutils literal notranslate"><span class="pre">Buffer</span></code> of the raw request body and <code class="docutils literal notranslate"><span class="pre">encoding</span></code> is the
encoding of the request. The parsing can be aborted by throwing an error.</p>
</section>
...
<p>The <code class="docutils literal notranslate"><span class="pre">depth</span></code> option is used to configure the maximum depth of the <code class="docutils literal notranslate"><span class="pre">qs</span></code> library when <code class="docutils literal notranslate"><span class="pre">extended</span></code> is <code class="docutils literal notranslate"><span class="pre">true</span></code>. This allows you to limit the amount of keys that are parsed and can be useful to prevent certain types of abuse. Defaults to <code class="docutils literal notranslate"><span class="pre">32</span></code>. It is recommended to keep this value as low as possible.</p>
</section>
</section>
</section>
<section id="errors">
...
<a class="reference external" href="https://www.npmjs.com/package/http-errors"><code class="docutils literal notranslate"><span class="pre">http-errors</span></code> module</a>. The errors
will typically have a <code class="docutils literal notranslate"><span class="pre">status</span></code>/<code class="docutils literal notranslate"><span class="pre">statusCode</span></code> property that contains the suggested
HTTP response code, an <code class="docutils literal notranslate"><span class="pre">expose</span></code> property to determine if the <code class="docutils literal notranslate"><span class="pre">message</span></code> property
should be displayed to the client, a <code class="docutils literal notranslate"><span class="pre">type</span></code> property to determine the type of
error without matching against the <code class="docutils literal notranslate"><span class="pre">message</span></code>, and a <code class="docutils literal notranslate"><span class="pre">body</span></code> property containing
...
<h3>content encoding unsupported<a class="headerlink" href="#content-encoding-unsupported" title="Link to this heading">#</a></h3>
...
<section id="entity-parse-failed">
<h3>entity parse failed<a class="headerlink" href="#entity-parse-failed" title="Link to this heading">#</a></h3>
<p>This error will occur when the request contained an entity that could not be
parsed by the middleware. The <code class="docutils literal notranslate"><span class="pre">status</span></code> property is set to <code class="docutils literal notranslate"><span class="pre">400</span></code>, the <code class="docutils literal notranslate"><span class="pre">type</span></code>
property is set to <code class="docutils literal notranslate"><span class="pre">'entity.parse.failed'</span></code>, and the <code class="docutils literal notranslate"><span class="pre">body</span></code> property is set to
the entity value that failed parsing.</p>
</section>
<section id="entity-verify-failed">
<h3>entity verify failed<a class="headerlink" href="#entity-verify-failed" title="Link to this heading">#</a></h3>
<p>This error will occur when the request contained an entity that could not be
failed verification by the defined <code class="docutils literal notranslate"><span class="pre">verify</span></code> option. The <code class="docutils literal notranslate"><span class="pre">status</span></code> property is
set to <code class="docutils literal notranslate"><span class="pre">403</span></code>, the <code class="docutils literal notranslate"><span class="pre">type</span></code> property is set to <code class="docutils literal notranslate"><span class="pre">'entity.verify.failed'</span></code>, and the
<code class="docutils literal notranslate"><span class="pre">body</span></code> property is set to the entity value that failed verification.</p>
</section>
<section id="request-aborted">
<h3>request aborted<a class="headerlink" href="#request-aborted" title="Link to this heading">#</a></h3>
...
<h3>request entity too large<a class="headerlink" href="#request-entity-too-large" title="Link to this heading">#</a></h3>
...
<h3>request size did not match content length<a class="headerlink" href="#request-size-did-not-match-content-length" title="Link to this heading">#</a></h3>
...
<h3>stream encoding should not be set<a class="headerlink" href="#stream-encoding-should-not-be-set" title="Link to this heading">#</a></h3>
...
<section id="stream-is-not-readable">
<h3>stream is not readable<a class="headerlink" href="#stream-is-not-readable" title="Link to this heading">#</a></h3>
<p>This error will occur when the request is no longer readable when this middleware
attempts to read it. This typically means something other than a middleware from
this module read the request body already and the middleware was also configured to
read the same request. The <code class="docutils literal notranslate"><span class="pre">status</span></code> property is set to <code class="docutils literal notranslate"><span class="pre">500</span></code> and the <code class="docutils literal notranslate"><span class="pre">type</span></code>
property is set to <code class="docutils literal notranslate"><span class="pre">'stream.not.readable'</span></code>.</p>
</section>
<section id="too-many-parameters">
<h3>too many parameters<a class="headerlink" href="#too-many-parameters" title="Link to this heading">#</a></h3>
...
<h3>unsupported charset “BOGUS”<a class="headerlink" href="#unsupported-charset-bogus" title="Link to this heading">#</a></h3>
...
<h3>unsupported content encoding “bogus”<a class="headerlink" href="#unsupported-content-encoding-bogus" title="Link to this heading">#</a></h3>
<p>This error will occur when the request had a <code class="docutils literal notranslate"><span class="pre">Content-Encoding</span></code> header that
...
<section id="the-input-exceeded-the-depth">
<h3>The input exceeded the depth<a class="headerlink" href="#the-input-exceeded-the-depth" title="Link to this heading">#</a></h3>
<p>This error occurs when using <code class="docutils literal notranslate"><span class="pre">bodyParser.urlencoded</span></code> with the <code class="docutils literal notranslate"><span class="pre">extended</span></code> property set to <code class="docutils literal notranslate"><span class="pre">true</span></code> and the input exceeds the configured <code class="docutils literal notranslate"><span class="pre">depth</span></code> option. The <code class="docutils literal notranslate"><span class="pre">status</span></code> property is set to <code class="docutils literal notranslate"><span class="pre">400</span></code>. It is recommended to review the <code class="docutils literal notranslate"><span class="pre">depth</span></code> option and evaluate if it requires a higher value. When the <code class="docutils literal notranslate"><span class="pre">depth</span></code> option is set to <code class="docutils literal notranslate"><span class="pre">32</span></code> (default value), the error will not be thrown.</p>
</section>
</section>
<section id="examples">
<h2>Examples<a class="headerlink" href="#examples" title="Link to this heading">#</a></h2>
<section id="express-connect-top-level-generic">
<h3>Express/Connect top-level generic<a class="headerlink" href="#express-connect-top-level-generic" title="Link to this heading">#</a></h3>
...
<h3>Express route-specific<a class="headerlink" href="#express-route-specific" title="Link to this heading">#</a></h3>
...
<h3>Change accepted type for parsers<a class="headerlink" href="#change-accepted-type-for-parsers" title="Link to this heading">#</a></h3>
...
<p><a class="reference download internal" download="" href="../../../../../../../../_downloads/0a04f5e86b8b152654aabcf505eec113/LICENSE"><span class="xref download myst">MIT</span></a></p>
</section>
</section>
